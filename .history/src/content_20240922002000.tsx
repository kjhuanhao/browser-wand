...
const PlasmoOverlay = () => {
  ...
  return (
    <div className="plasmo-z-50 plasmo-flex plasmo-fixed plasmo-inset-0 plasmo-bg-black plasmo-bg-opacity-50">
      <div className="plasmo-m-auto plasmo-bg-white plasmo-p-6 plasmo-rounded-lg plasmo-shadow-xl plasmo-h-[540px] plasmo-max-w-[700px]">
        <input
        ...
        <div className="plasmo-mt-4 plasmo-flex plasmo-justify-between">
          <span>{(searchResult && searchResult.length) || "0"}个结果</span>
          {/* <div>
